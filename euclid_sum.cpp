//Soma euclidiana by Matheus Regis em C++
//SYSTEM PLATAFORM ASSEMBLED: Ubuntu Linux
//POWER: AMD RYZEN 5 3450U-DELL
//Aviso: Use,vai ta errado :)
#include<iostream>//declara iostream, feijão com arroz
...
int main()
{
  ...
  D=sqrt(sum);
  std::cout << "A soma euclidiana das coordenadas são: "<< D << std::endl; //exibe na tela os bagui
